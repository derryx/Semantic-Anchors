...
** *SIL 1* (lowest): PFD 10^-2^ to 10^-1^ (tolerable risk reduction)
** *SIL 2*: PFD 10^-3^ to 10^-2^ (moderate risk reduction)
** *SIL 3*: PFD 10^-4^ to 10^-3^ (substantial risk reduction)
** *SIL 4* (highest): PFD 10^-5^ to 10^-4^ (maximum risk reduction)
