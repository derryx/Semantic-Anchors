...
[%collapsible]
====
*Vollständiger Name*: Socratic Method (also Socratic Dialogue, Elenchus)
...
*Schlüsselvertreter*: Socrates (via Plato's dialogues, ~400 BCE)

*Historischer Kontext*: 2400+ years of philosophical tradition, foundational to Western philosophy and critical thinking education
